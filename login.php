...
<body class="form-v8">
	<div class="page-content">
		<div class="form-v8-content">
			...
			<h1><center>Selamat Datang di <br>Cam Erentz<span class="label label-default"></span></center></h1>
				<div class="tab">
				
					<div class="tab-inner">
						<button class="tablinks" onclick="openCity(event, 'sign-up')" id="defaultOpen">Masuk</button>
					</div>
					<div class="tab-inner">

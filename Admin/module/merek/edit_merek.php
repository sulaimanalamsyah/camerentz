<?php 
	...
	if (empty($_SESSION['username']) AND empty($_SESSION['passuser'])){
        ...
        include "../lib/koneksi.php";
  		...
  		$queryEdit=mysqli_query($koneksi, "SELECT * FROM merek WHERE id_merek='$idMerek'");
				...
				<section class="main__box">
					...
					<table class="table table--gray">
						...
						<tbody>
							<tr>
                            <label></label>
                                <input type="text" name="merek" placeholder="Nama merek" class="form form--focus-blue" value="<?php echo $namaMerek; ?>">
								<input type="hidden" name="id_merek" placeholder="id" class="form form--focus-blue" value="<?php echo $idMerek; ?>">
							</tr>

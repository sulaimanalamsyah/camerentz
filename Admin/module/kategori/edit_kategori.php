				...
				<section class="main__box">
					...
					<table class="table table--gray">
						...
						<tbody>
							<tr>
                            <label></label>
                                <input type="text" name="kategori" placeholder="Nama kategori" class="form form--focus-blue" value="<?php echo $namakategori; ?>">
								<input type="hidden" name="id_kategori" placeholder="id" class="form form--focus-blue" value="<?php echo $idkategori; ?>">
							</tr>

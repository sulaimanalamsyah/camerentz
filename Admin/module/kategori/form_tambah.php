...
<body>	
	...
	<main class="main main--ml-sidebar-width">
        ...
        <form class="form-horizontal" action="../Admin/module/kategori/aksi_tambah.php" method="POST">
				<section class="main__box">
					...
					<table class="table table--gray">
						...
						<tbody>
							<tr>
                            <label></label>
                                <input type="text" name="kategori" placeholder="Nama kategori" class="form form--focus-blue">
